  ...
  return (
    <div className="w-full">
      <Timeline data={timeline}>
        <div className="flex h-auto w-full flex-col items-center justify-center bg-[url(/images/pre1.jpeg)] bg-cover bg-center px-4 py-20 md:h-[500px] md:px-8 lg:px-10">
